...
function factoryRespreadGraph(ParentClassSpreadGraph) {
  var RespreadGraph = function (_ParentClassSpreadGra) {
    _inherits(RespreadGraph, _ParentClassSpreadGra);

    function RespreadGraph() {
      _classCallCheck(this, RespreadGraph);

      return _possibleConstructorReturn(this, (RespreadGraph.__proto__ || Object.getPrototypeOf(RespreadGraph)).apply(this, arguments));
    }

    _createClass(RespreadGraph, [{
      key: 'insert',
      ...
      value: function insert(modifier, callback, context) {
        ...
        return _get(RespreadGraph.prototype.__proto__ || Object.getPrototypeOf(RespreadGraph.prototype), 'insert', this).call(this, modifier, callback, context);
      }
      ...
      value: function remove(selector, callback, context) {
        if (context && context.launched) {
          if (!context.modifier) context.modifier = {};
          context.modifier.launched = { add: context.launched };
        }
        return _get(RespreadGraph.prototype.__proto__ || Object.getPrototypeOf(RespreadGraph.prototype), 'remove', this).call(this, selector, callback, context);
      }
    }]);

    return RespreadGraph;
  }(ParentClassSpreadGraph);

  return RespreadGraph;
};

exports.factoryRespreadGraph = factoryRespreadGraph;
//# sourceMappingURL=spreaded.js.map