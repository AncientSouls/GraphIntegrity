...
var QueueSpreading = function () {
  ...
  _createClass(QueueSpreading, [{
    ...
    key: 'spreadByPath',
    value: function spreadByPath(pathGraph, pathLink) {
      var _this = this;
    ...
    key: 'unspreadByPath',
    value: function unspreadByPath(pathGraph, pathLink) {
      var _this2 = this;
    ...
    key: 'spreadBySpread',
    value: function spreadBySpread(spreadLink) {
      var _this3 = this;
      ...
      this.graphSpreading.spreadFromSpreadLink(spreadLink, context, undefined, function () {
        ...
        _this3.mayBeEndedLaunched(context.process, 'spread');
      });
    }
    ...
    value: function unspreadBySpread(spreadLink) {
      var _this4 = this;
      ...
      this.graphSpreading.unspreadFromunspreadBySpreadByPrevId(spreadLink.id, context, undefined, function () {
        ...
        _this4.mayBeEndedLaunched(launched, 'unspread');
      });
    }
    ...
    value: function spreadBySpreader(spreaderGraph, spreaderLink) {
      ...
      this.graphSpreading.spreadNewSpreadLink((_graphSpreading$sprea = {}, _defineProperty(_graphSpreading$sprea, this.graphSpreading.spreadGraph.constantField, spreaderLink[spreaderGraph.constantField]), _defineProperty(_graphSpreading$sprea, this.graphSpreading.spreadGraph.variableField, spreaderLink[spreaderGraph.variableField]), _defineProperty(_graphSpreading$sprea, 'spreader', spreaderLink.id), _graphSpreading$sprea), { process: spreaderLink.id }, function () {
        _this5.mayBeEndedLaunched(spreaderLink.id, 'spread');
      });
    }
    ...
    value: function unspreadBySpreader(spreaderGraph, spreaderLink) {
      var _this6 = this;

      this.graphSpreading.spreadGraph.remove({
        spreader: spreaderLink.id
      }, function (error, count) {
        _this6.mayBeEndedLaunched(spreaderLink.id, 'unspread');
