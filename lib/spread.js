 ...
 */function factorySpreadGraph(ParentClassGraph){var SpreadGraph=function(_ParentClassGraph){_inherits(SpreadGraph,_ParentClassGraph);/**
     ...
     */},{key:'insert',value:function insert(modifier,callback,context){if(context&&context[this.config.aliases.process]){modifier[this.config.aliases.process]=[context[this.config.aliases.process]]}return _get(SpreadGraph.prototype.__proto__||Object.getPrototypeOf(SpreadGraph.prototype),'insert',this).call(this,modifier,callback,context)}/**
     ...
     */},{key:'remove',value:function remove(selector,callback,context){if(context&&context[this.config.aliases.process]){if(!context.modifier)context.modifier={};context.modifier[this.config.aliases.process]={add:context[this.config.aliases.process]}}return _get(SpreadGraph.prototype.__proto__||Object.getPrototypeOf(SpreadGraph.prototype),'remove',this).call(this,selector,callback,context)}}]);return SpreadGraph}(ParentClassGraph);return SpreadGraph};exports.factorySpreadGraph=factorySpreadGraph;
