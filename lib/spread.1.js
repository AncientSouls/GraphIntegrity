...
function factorySpreadGraph(ParentClassGraph) {
  var SpreadGraph = function (_ParentClassGraph) {
     ...
     */
    function SpreadGraph(collection, selector, config) {
      _classCallCheck(this, SpreadGraph);

      var _this = _possibleConstructorReturn(this, (SpreadGraph.__proto__ || Object.getPrototypeOf(SpreadGraph)).apply(this, arguments));
    ...
    _createClass(SpreadGraph, [{
      ...
      key: '_unspreadingHandler',
      value: function _unspreadingHandler(spreadLink, context, callback) {
        callback(true);
      }
...
//# sourceMappingURL=spread.1.js.map