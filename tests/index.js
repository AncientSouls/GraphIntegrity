        ...
        _createClass(CustomExistedSpreadGraph, [{
          ...
          value: function _spreadingHandler(prevSpreadLink, pathGraph, pathLink, newSpreadLink, context, callback) {
            ...
            if (!pathLink) {
              ...
              pathGraph.get(pathLink.id, undefined, function (error, pathLink) {
                if (!pathLink) callback();else _this3.get({
                ...
                }, undefined, function (error, spreadLink) {
                  if (spreadLink) callback();else _this3.get(prevSpreadLink.id, undefined, function (error, prevSpreadLink) {
    ...
    (0, _testSpreader2.default)(function () {
      ...
      var NamedGraph = function (_Graph2) {
        ...
        function NamedGraph(collection, fields, config) {
          ...
          var _this5 = _possibleConstructorReturn(this, (NamedGraph.__proto__ || Object.getPrototypeOf(NamedGraph)).apply(this, arguments));

          if (config.name) _this5.name = config.name;
          return _this5;
        }
