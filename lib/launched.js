...
function factoryLaunchedGraph(ParentClassGraph) {
  var LaunchedGraph = function (_ParentClassGraph) {
    _inherits(LaunchedGraph, _ParentClassGraph);

    function LaunchedGraph() {
      _classCallCheck(this, LaunchedGraph);

      return _possibleConstructorReturn(this, (LaunchedGraph.__proto__ || Object.getPrototypeOf(LaunchedGraph)).apply(this, arguments));
    }

    _createClass(LaunchedGraph, [{
      key: 'insert',
      ...
      value: function insert(modifier, callback, context) {
        if (!modifier.launched) modifier.launched = ['spread'];else {
        ...
        return _get(LaunchedGraph.prototype.__proto__ || Object.getPrototypeOf(LaunchedGraph.prototype), 'insert', this).call(this, modifier, callback, context);
      }
      ...
      value: function update(selector, modifier, callback, context) {
        ...
        return _get(LaunchedGraph.prototype.__proto__ || Object.getPrototypeOf(LaunchedGraph.prototype), 'update', this).call(this, selector, modifier, callback, context);
      }
      ...
      value: function remove(selector, callback, context) {
        ...
        return _get(LaunchedGraph.prototype.__proto__ || Object.getPrototypeOf(LaunchedGraph.prototype), 'remove', this).call(this, selector, callback, context);
      }
    }]);
...
exports.factoryLaunchedGraph = factoryLaunchedGraph;
